        ...
        <div className="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-6 rounded-xl shadow-lg transform hover:scale-105 transition duration-500 mt-4">
            ...
            <div className="mt-4  text-xl  cursor-pointer">
              ...
              <li>Spread Sheet</li>
              <li>Presentation</li>
              <li>Introduction to Internet & WWW</li>
              <li>Mail , Social Media Networking</li>
              <li>E-Governance</li>
              <li>Digital Financial Applications</li>
              <li>Overview of Cyber Security</li>
              <li>Overview of Future Skills & Intelligence</li>
              <li>Project</li>
            </div>
            <div className="my-4">
            <button className="mt-12 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">
          ...
          <div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="mt-4  text-xl  cursor-pointer">
              <li>M1-R5 : Information Technology Tools brand Network Basics</li>
              <li>M2-R5 : Web Designing & Publishing</li>
              <li>M3-R5 : Programming and Problem Solving through (Python)</li>
              <li>M4-R5 : Internet of things(IOT) and its Application</li>
              <li>Practical 1 Based on M1-R5</li>
              <li>Practical 2 Based on M2-R5</li>
              <li>Practical 3 Based on M3-R5</li>
              <li>Practical 4 Based on M4-R5</li>
              <li>M6-R5 : Project </li>
            </div>
            <div className="my-4">
            <button className="mt-12 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">
